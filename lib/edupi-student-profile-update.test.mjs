...
test("profile changes carry explicit identity and class", () => {
  const request = buildStudentProfileUpdateRequest({name:"张三",studentId:"student-b",className:"C",traits:[],parentNotes:[],expectedUpdatedAt:"2026-09-01T00:00:00Z"},"update-b");
