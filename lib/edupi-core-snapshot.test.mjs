...
test("health requires every platform projection operation", async () => {
  ...
  assert.match(source, /CORE_OPERATIONS = \["health", "snapshot", "workspace-resources", "generated-artifacts", "command", "students", "delete", "kernel", "memory-scopes", "teaching-skills", "connectors", "agent-computer", "platform", "connector-setup"\]/);
