...
export type EduPiCompatManifest = {
  ...
  core_runtime: { core_commit: "5538021f171a647d87562d91e5ab953f794e2331"; component_manifest_path: "contracts/edupi-desktop-component-manifest.json"; component_manifest_hash: "sha256:649c13fd9d6f0defa56a189176cab0e2a461355131397a4601d260fa1d08d922" };
  ...
  unsupported_command_reasons: Record<Exclude<CoreCommandType, "review_observation" | "review_memory_candidate" | "review_teacher_context" | "review_work_candidate" | "import_calendar" | "import_timetable" | "intake_material" | "create_task" | "move_task_stage">, string>;
...
export function loadEduPiCompatManifest(): EduPiCompatManifest {
  ...
  const supportedCommands = ["review_observation", "review_memory_candidate", "review_teacher_context", "review_work_candidate", "import_calendar", "import_timetable", "intake_material", "create_task", "move_task_stage"] as const;
