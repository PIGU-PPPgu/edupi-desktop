...
export type EduPiCompatManifest = {
  ...
  core_runtime: { core_commit: "b1145350d3cd96baf2a22c1d27e29020fd564613"; component_manifest_path: "contracts/edupi-desktop-component-manifest.json"; component_manifest_hash: "sha256:2d2d03e9723d5e51200a5904fd764ec4c142d2c2ca037235e1e4c5598ec2e1d8" };
...
export function loadEduPiCompatManifest(): EduPiCompatManifest {
  ...
  if (!manifest.core_runtime || manifest.core_runtime.core_commit !== "b1145350d3cd96baf2a22c1d27e29020fd564613" || manifest.core_runtime.component_manifest_path !== "contracts/edupi-desktop-component-manifest.json" || manifest.core_runtime.component_manifest_hash !== "sha256:2d2d03e9723d5e51200a5904fd764ec4c142d2c2ca037235e1e4c5598ec2e1d8") throw new Error("Invalid EduPi core_runtime identity");
