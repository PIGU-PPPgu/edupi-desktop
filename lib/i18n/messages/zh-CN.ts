...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.startDictation": "开始口述",
    "chat.stopDictation": "停止口述",
    "chat.dictationError": "口述没有开始",
    "chat.dictationPermissionDenied": "请允许麦克风权限后重试。",
    "chat.dictationTryAgain": "请再试一次，原有文字仍然保留。",
    ...
    "models.baseUrlLabel": "接口地址",
    "models.keyPlaceholder": "填写 API Key",
    "models.keyAdvanced": "高级密钥用法",
    "models.keyHelp": "也可填写环境变量名，或使用 ! 开头的命令读取密钥。",
    "models.idLabel": "模型 ID",
    "models.nameLabel": "显示名称",
    "models.apiOverrideLabel": "模型接口类型",
    "models.reasoningLabel": "推理能力",
    "models.imageInputLabel": "图片输入",
    "models.contextWindowLabel": "上下文 token 数",
    "models.maxTokensLabel": "最大输出 token 数",
    "models.costLabel": "每百万 token 价格",
    ...
    "updates.caption": "{product} 会检查官方 EduPi 发布。可在设置中下载并安装完整的签名更新。",
    "updates.openSettings": "打开设置",
    "appSettings.tagline": "{product} 是教师行事历与教育工作的本地智能体桌面端。",
    "appSettings.taglineDetails": "日程、任务、材料、学生档案与 AI 对话在一个工作台中协同，数据保留在你的电脑上。",
    ...
    "appSettings.checkUpdates": "检查更新",
    "appSettings.checking": "检查中…",
    ...
    "appSettings.dataSection": "EduPi 数据",
    "appSettings.dataDirectory": "当前目录",
    "appSettings.dataSource": "数据：{source}",
    "appSettings.dataSource.environment": "环境变量",
    "appSettings.dataSource.persisted": "已选择",
    "appSettings.dataSource.managed": "默认目录",
    "appSettings.coreSource": "Core：{source}",
    "appSettings.coreSource.environment": "开发目录",
    "appSettings.coreSource.bundled": "已内置",
    "appSettings.dataFallback": "已回退：{reason}",
    "appSettings.dataEnvironmentLocked": "当前由环境变量控制。",
    "appSettings.dataChoose": "选择目录",
    "appSettings.dataSelectTitle": "选择 EduPi 数据目录",
    "appSettings.dataReset": "使用默认目录",
