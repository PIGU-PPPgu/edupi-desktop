...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.startDictation": "Start dictation",
    "chat.stopDictation": "Stop dictation",
    "chat.dictationError": "Dictation did not start",
    "chat.dictationPermissionDenied": "Allow microphone access and try again.",
    "chat.dictationTryAgain": "Try again. Your existing draft is unchanged.",
    ...
    "models.keyPlaceholder": "API key",
    "models.keyAdvanced": "Advanced key options",
    "models.keyHelp": "Use an environment variable name or prefix a shell command with !.",
    "models.idLabel": "Model ID",
    "models.nameLabel": "Display name",
    "models.apiOverrideLabel": "API override",
    "models.reasoningLabel": "Reasoning",
    "models.imageInputLabel": "Image input",
    "models.contextWindowLabel": "Context window (tokens)",
    "models.maxTokensLabel": "Max output tokens",
    "models.costLabel": "Cost per million tokens",
    ...
    "updates.caption": "{product} checks official EduPi releases. Download and install complete signed updates in Settings.",
    "updates.openSettings": "Open Settings",
    "appSettings.tagline": "{product} is the local agent desktop for a teacher's calendar and education work.",
    "appSettings.taglineDetails": "Schedules, tasks, materials, student records, and AI chat work together in one local workspace.",
    ...
    "appSettings.checkUpdates": "Check for updates",
    "appSettings.checking": "Checking…",
    ...
    "appSettings.dataSection": "EduPi data",
    "appSettings.dataDirectory": "Directory",
    "appSettings.dataSource": "Data: {source}",
    "appSettings.dataSource.environment": "environment",
    "appSettings.dataSource.persisted": "selected",
    "appSettings.dataSource.managed": "default",
    "appSettings.coreSource": "Core: {source}",
    "appSettings.coreSource.environment": "developer path",
    "appSettings.coreSource.bundled": "bundled",
    "appSettings.dataFallback": "Fallback: {reason}",
    "appSettings.dataEnvironmentLocked": "Controlled by an environment override.",
    "appSettings.dataChoose": "Choose directory",
    "appSettings.dataSelectTitle": "Choose EduPi data directory",
    "appSettings.dataReset": "Use default directory",
    ...
    "appSettings.quitApp": "Quit EduPi",
