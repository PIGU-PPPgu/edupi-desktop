...
test("pins the Core v1.1 education projection runtime capability manifest", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "b1145350d3cd96baf2a22c1d27e29020fd564613");
  assert.equal(manifest.core_runtime.component_manifest_hash, "sha256:2d2d03e9723d5e51200a5904fd764ec4c142d2c2ca037235e1e4c5598ec2e1d8");
  assert.equal(manifest.contract_identities.length, 1);
  assert.deepEqual(manifest.supported_commands, ["review_observation", "review_memory_candidate", "review_teacher_context", "review_work_candidate", "review_task", "import_calendar", "import_timetable", "intake_material", "create_task", "move_task_stage"]);
  assert.deepEqual(manifest.contract_identities[0].supported_commands, ["review_observation", "review_memory_candidate", "review_teacher_context", "review_work_candidate", "review_task", "import_calendar", "import_timetable", "intake_material", "create_task", "move_task_stage"]);
