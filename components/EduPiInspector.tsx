  ...
  return (
    <aside className="edupi-task-inspector" aria-label="任务检查">
      ...
      {task ? <>
        ...
        <section><h3>协作</h3><button type="button" className="edupi-inspector-action" onClick={onOpenAgent}>打开协作</button><button type="button" className="edupi-inspector-action" onClick={() => onStage("review")}>进入审核</button></section>
