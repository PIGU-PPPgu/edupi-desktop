...
export function EduPiMemoryDatabase({ data, query, selectedObjectId, onEducation, onStartAgent }: { data: EducationContract; query: string; selectedObjectId: string | null; onEducation: (data: EducationContract) => void; onStartAgent: (prompt: string, mode?: "insert" | "replace") => void }) {
