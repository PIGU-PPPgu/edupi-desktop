...
export async function GET(request:Request) {
  ...
  try {return NextResponse.json(await studentEventRequest({action:"list_events",student:query.get("student")||undefined,kind:kind||undefined,offset,query:query.get("query")||undefined,from:query.get("from")||undefined,to:query.get("to")||undefined},request.signal));}
