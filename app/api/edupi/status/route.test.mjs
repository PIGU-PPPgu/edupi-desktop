...
test("projects only validated Core health and education snapshot", { skip: !coreRoot || !dataRoot }, async () => {
  ...
  assert.deepEqual(body.core.supportedCommands, ["review_observation", "review_memory_candidate", "review_teacher_context", "review_work_candidate", "import_calendar", "import_timetable", "intake_material", "create_task", "move_task_stage"]);
